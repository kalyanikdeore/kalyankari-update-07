      ...
      <div class="lg:col-span-2">
        <div class="py-8 lg:pe-8">
          <div class="space-y-5 lg:space-y-8">
            ...
            <h2 class="text-3xl font-bold lg:text-5xl dark:text-white">{{$blogs[$n]->title}}</h2>
            ...
            <div class="flex items-center gap-x-5">
              ...
              <p class="text-xs sm:text-sm text-gray-800 dark:text-neutral-200">{{date('F j, Y',strtotime($blogs[$n]->created_at))}} </p>
            </div>
  
            <p class="text-lg text-gray-800 dark:text-neutral-200">{{$blogs[$n]->introduction}}</p>
{{--   
...
{{--   
            <div class="text-center">
              <div class="grid lg:grid-cols-2 gap-3">
                ...
                <figure class="relative w-full h-72 sm:h-96 lg:h-full">
                  <img class="size-full absolute top-0 start-0 object-cover rounded-xl" src="{{asset('storage/'.$blogs[$n]->image)}}"  alt="Blog Image">
                </figure>
              </div>
            ...
            <img class="  object-cover rounded-xl" src="{{asset('storage/'.$blogs[$n]->image)}}"  alt="Blog Image">
  
            <p class="text-lg text-gray-800 dark:text-neutral-200">{{$blogs[$n]->description}}</p>
  ...
  <h1 class="text-5xl text-black captialize">Other Blogs</h1>
            {{-- <div class="grow">
          ...
          <div class="space-y-6">
            ...
            <a class="group flex items-center gap-x-6 focus:outline-none" onclick="showBlogs('{{$blog->id}}')">
              <div class="grow">
              ...
              <div class="shrink-0 relative rounded-lg overflow-hidden size-20">
                <img class="size-full absolute top-0 start-0 object-cover rounded-lg" src="{{asset('storage/'.$blog->image)}}" alt="Blog Image">
              </div>
            </a>  
            @endforeach
