...
<x-breadscrumb pageName="Donation"/>
      ...
      <div class="space-y-6 lg:space-y-10">
        ...
        <div class="flex gap-x-5 sm:gap-x-8">
          ...
          <div class="grow">
            ...
            <p class="mt-1 text-gray-600 dark:text-neutral-400">
              Your financial support helps provide scholarships and resources to deserving students, enabling them to pursue their education and achieve their dreams.
            </p>
          </div>
        </div>
        <!-- End Icon Block -->
        ...
        <div class="flex gap-x-5 sm:gap-x-8">
          ...
          <div class="grow">
            ...
            <p class="mt-1 text-gray-600 dark:text-neutral-400">
              Many in our community face financial hardships. Your donation helps provide critical assistance to those who need it most, ensuring they have access to basic needs and opportunities.
            </p>
          </div>
        </div>
        <!-- End Icon Block -->
        ...
        <div class="flex gap-x-5 sm:gap-x-8">
          ...
          <div class="grow">
            ...
            <p class="mt-1 text-gray-600 dark:text-neutral-400">
              Our organization relies on the generosity of donors to maintain and expand our initiatives. Your contribution directly supports ongoing projects, allowing us to serve more individuals and make a greater impact.
            </p>
          </div>
        </div>
        <!-- End Icon Block -->
...
{{-- <div class="max-w-2xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-neutral-900">
      ...
      <div class="py-6 first:pt-0 last:pb-0 border-t first:border-transparent border-gray-200 dark:border-neutral-700 dark:first:border-transparent">
        ...
        <div class="mt-2 space-y-3">
          ...
          <div class="flex flex-col sm:flex-row gap-3">
            ...
            <select class="py-2 px-3 pe-9 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-orange-500 focus:ring-orange-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
    ...
    <div class="mt-5 flex justify-end gap-x-2">
      ...
      <button type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-orange-600 text-white hover:bg-orange-700 focus:outline-none focus:bg-orange-700 disabled:opacity-50 disabled:pointer-events-none">
        Save changes
      </button>
    </div>
  </div>
  ...
  <div class="grid md:grid-cols-2 items-center gap-12">
    <div>
      ...
      <p class="mt-1 md:text-lg text-gray-800 dark:text-neutral-200">
        {{$why_donates->description}}
      </p>

      <div class="mt-8">
        <h2 class="text-lg font-semibold text-gray-800 dark:text-neutral-200">
          {{$why_donates->list_title}}
        </h2>

        <ul class="mt-2 space-y-2">
          @foreach (json_decode($why_donates->list) as $items)
