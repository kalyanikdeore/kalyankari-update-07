...
<div class="item">
<div class="flex justify-center h-full" style="background-image: url('{{asset('./storage/'.$hero->image)}}'); height: 100vh; width: 100%; background-position: center; background-size: cover;">
      


      
      <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pb-36 pt-16 " >
          <!-- Grid -->
          <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div class="mt-32">
              <h1 class="block text-2xl font-bold text-gray-800 sm:text-4xl lg:text-4xl lg:leading-tight dark:text-white">Kalyankari Pratishthan </h1>
              <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">{{$hero->title}} </h1>
              {{-- <p class="mt-3 text-lg text-gray-800 dark:text-neutral-400">Your Support Can Create Opportunities for Every Child</p> --}}
              <p class="mt-3 text-lg text-gray-800 dark:text-neutral-400 text-justify">{{$hero->description}}</p>
        
              <!-- Buttons -->
              <div class="mt-7 grid gap-3 w-full sm:inline-flex">
                <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-orange-600 text-white hover:bg-orange-700 focus:outline-none focus:bg-orange-700 disabled:opacity-50 disabled:pointer-events-none" href="{{route('application')}}">
                  Get started
                  <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
                </a>
                <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" href="{{route('donation')}}">
                  Donate Now
                </a>
              </div>
              <!-- End Buttons -->
            ...
            <div class="relative ms-4">
              {{-- <img class="w-full rounded-md" src="{{asset('assets/images/modal.png')}}" alt="Hero Image"> --}}
