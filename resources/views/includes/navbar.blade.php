...
<header class="flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-gray-800 text-sm  dark:bg-white ">
    <nav class="relative max-w-[85rem] w-full mx-auto md:flex md:items-center md:justify-between md:gap-x-3  px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center gap-x-1">
        <a class="flex-none font-semibold text-xl text-black focus:outline-none focus:opacity-80 dark:text-white" href="#" aria-label="Brand">
          <img src="{{asset('assets/images/logo.png')}}" width="42%" />
        </a>
  
        <!-- Collapse Button -->
        <button type="button" class="hs-collapse-toggle md:hidden relative size-9 flex justify-center items-center font-medium text-[12px] rounded-lg border border-gray-200 text-gray-800 bg-gray-100 focus:outline-none focus:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:border-neutral-700 dark:bg-neutral-700 dark:focus:bg-neutral-700" id="hs-header-base-collapse"  aria-expanded="false" aria-controls="hs-header-base" aria-label="Toggle navigation"  data-hs-collapse="#hs-header-base" >
          ...
          <div class="py-2 md:py-0  flex flex-col md:flex-row md:items-center gap-0.5 md:gap-1">
            <div class="grow">
              <div class="flex flex-col md:flex-row md:justify-end md:items-center gap-0.5 md:gap-1">
                <a class="font-medium {{Route::is('home')?'text-orange-500':'text-gray-300'}} hover:text-orange-500 focus:outline-none focus:text-white ms-5" href="{{route('home')}}" aria-current="page">
               ...
               Home
                ...
                <a class="font-medium {{Route::is('about')?'text-orange-500':'text-gray-300'}}   hover:text-orange-500 focus:outline-none focus:text-white ms-5" href="{{route('about')}}" >
                 
                  About Us
                  
                </a>

                <!--<a class="font-medium {{Route::is('causes')?'text-orange-500':'text-gray-300'}} hover:text-orange-500 focus:outline-none focus:text-white ms-5" href="{{route('causes')}}" >-->
                ...
                <!--</a>-->
                     ...
                     <div class="hs-dropdown [--strategy:static] md:[--strategy:fixed] [--adaptive:none] [--is-collapse:true] md:[--is-collapse:false] ">
                      <button id="hs-header-base-dropdown" type="button" class="hs-dropdown-toggle w-full  flex items-center rounded-lg font-medium text-gray-300 {{Route::is('application')?'text-orange-500':'text-gray-300'}} {{Route::is('eligibility')?'text-orange-500':'text-gray-300'}} {{Route::is('beneficiary_student')?'text-orange-500':'text-gray-300'}}
                      hover:text-orange-500 focus:outline-none focus:text-white ms-5" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                      ...
                      <div class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 relative w-full md:w-52 hidden z-10 top-full ps-7 md:ps-0 md:bg-white md:rounded-lg md:shadow-md before:absolute before:-top-4 before:start-0 before:w-full before:h-5 md:after:hidden after:absolute after:top-1 after:start-[18px] after:w-0.5 after:h-[calc(100%-0.25rem)] after:bg-gray-100 dark:md:bg-neutral-800 dark:after:bg-neutral-700" role="menu" aria-orientation="vertical" aria-labelledby="hs-header-base-dropdown">
                        <div class="py-1 md:px-1 space-y-0.5">
                          <a href="{{route('application')}}" class="p-2 md:px-3 flex items-center text-sm text-white hover:bg-gray-100 hover:text-gray-800 sm:text-gray-800   rounded-lg sm:hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700 dark:focus:text-neutral-300">
                           Application Form
                          </a>
                          ...
                          <a class="p-2 md:px-3 flex items-center text-sm text-white hover:bg-gray-100 hover:text-gray-800 sm:text-gray-800   rounded-lg sm:hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700 dark:focus:text-neutral-300" href="{{route('eligibility')}}">
                            Eligiblity Criteria
                          </a>
      
                          <a class="p-2 md:px-3 flex items-center text-sm text-white hover:bg-gray-100 hover:text-gray-800 sm:text-gray-800   rounded-lg sm:hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700 dark:focus:text-neutral-300" href="{{route('beneficiary_student')}}">
                           List Of Beneficiary
                          </a>
                              <a class="p-2 md:px-3 flex items-center text-sm text-white hover:bg-gray-100 hover:text-gray-800 sm:text-gray-800   rounded-lg sm:hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700 dark:focus:text-neutral-300" href="{{route('download')}}">
                ...
                <a class="font-medium {{Route::is('all_stories')?'text-orange-500':'text-gray-300'}}
                {{Route::is('stories')?'text-orange-500':'text-gray-300'}}
                      hover:text-orange-500 focus:outline-none focus:text-white ms-5" href="{{route('all_stories')}}">
              
                  Success Stories
                  
                </a>
  
                <a class="font-medium {{Route::is('gallery')?'text-orange-500':'text-gray-300'}}
                      hover:text-orange-500 focus:outline-none focus:text-white ms-5" href="{{route('gallery')}}">
    
                  Gallery
                </a>

                <a class="font-medium {{Route::is('donation')?'text-orange-500':'text-gray-300'}}
                      hover:text-orange-500 focus:outline-none focus:text-white ms-5" href="{{route('donation')}}" >
                 
                Donation
                  
                </a>
  
                <a class="font-medium {{Route::is('blog')?'text-orange-500':'text-gray-300'}}
                      hover:text-orange-500 focus:outline-none focus:text-white ms-5" href="{{route('blog')}}">
          
                  Blog
                  
                </a>

                <a class="font-medium {{Route::is('contact')?'text-orange-500':'text-gray-300'}}
                      hover:text-orange-500 focus:outline-none focus:text-white ms-5" href="{{route('contact')}}">
            ...
            <div class=" flex flex-wrap items-center gap-x-1.5">
              ...
              <a class="py-2 px-2.5 inline-flex items-center font-medium text-sm rounded-lg bg-orange-600 text-white hover:bg-orange-700 focus:outline-none focus:bg-orange-700 disabled:opacity-50 disabled:pointer-events-none dark:bg-orange-500 dark:hover:bg-orange-600 dark:focus:bg-orange-600" href="{{route('application')}}">
